						...
						$conn = mysqli_connect("localhost", "root", "", "island_express");
			 			...
			 			if ($result-> num_rows > 0){
							while($row = $result -> fetch_assoc()){
								echo "<tr><td>" . "<center>" . $row['id'] . "</td><td>" . "<center>" . $row['userName'] . "</center>" . "</td><td>" . "<center>" .  $row['cityfrom'] . "</center>" . "</td><td>" . "<center>" .  $row['cityto'] . "</center>" . "</td><td>" . "<center>" .  $row['amount'] . "(LKR)" . "</center>" . "</td><td>" . "<center>" .  $row['date'] . "</center>" . "</td></tr>";
							}
							echo "</table>";
			 			}
			 			else{
